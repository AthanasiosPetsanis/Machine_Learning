...
The LivingRoom part 0 is some text that varies. The LivingRoom part 0 is "Guess what, you are in a place we're calling a LivingRoom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 Oh, great. Here's a table. Wow, isn't TextWorld just the best? [if there is something on the s_0]You see [a list of things on the s_0] on the table.[end if]".
...
The LivingRoom part 3 is some text that varies. The LivingRoom part 3 is " door leading west. There is an unguarded exit to the north.".
...
The Bedroom part 0 is some text that varies. The Bedroom part 0 is "You've entered a Bedroom. The room is well lit.
 ...
 You can see a bed. [if there is something on the s_1]On the bed you see [a list of things on the s_1].[end if]".
The Bedroom part 1 is some text that varies. The Bedroom part 1 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. You swear loudly.[end if]".
...
The o_2 are object-likes.
The o_2 are privately-named.
The r_2 and the r_0 and the r_1 are rooms.
...
The s_1 is in r_0.
The description of o_2 is "The blanket is well-used.".
