...
The Kitchen part 0 is some text that varies. The Kitchen part 0 is "You find yourself in a Kitchen. A normal kind of place. The room is well lit.
 ...
 You make out a counter. [if there is something on the s_2]On the counter you can make out [a list of things on the s_2].[end if]".
The Kitchen part 1 is some text that varies. The Kitchen part 1 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The description of o_1 is "The banana would seem to be out of place here".
The printed name of o_1 is "banana".
Understand "banana" as o_1.
